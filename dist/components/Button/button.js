...
var Button = function (props) {
    var _a;
    var className = props.className, btnType = props.btnType, size = props.size, disabled = props.disabled, href = props.href, children = props.children, restProps = __rest(props, ["className", "btnType", "size", "disabled", "href", "children"]);
